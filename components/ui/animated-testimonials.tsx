...
export const AnimatedTestimonials = ({
  ...
  const testimonialRotations = useMemo(() => {
    if (!isClient) { 
  ...
  }, [autoplay, active, testimonials.length, isClient]); 
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  initial={{
                    ...
                    scale: 0.9,
                    z: -100,
                    rotate: isClient ? testimonialRotations[index] : 0, 
                  }}
                  animate={{
                    opacity: isActive(index) ? 1 : 0.7,
                    scale: isActive(index) ? 1 : 0.95,
                    z: isActive(index) ? 0 : -100,
                    rotate: isActive(index) ? 0 : (isClient ? testimonialRotations[index] : 0),
        ...
        {/* ... Sisa JSX (bagian teks testimonial dan tombol navigasi) ... */}
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <p className="text-sm text-green-300 dark:text-neutral-500">
