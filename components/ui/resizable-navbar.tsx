      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-gray-500 text-green-400 dark:bg-neutral-800"
            />
          )}
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none text-white bg-gradient-to-r from-emerald-500 to-teal-700 hover:from-emerald-600 hover:to-teal-800",
