        ...
        >
          ...
          >
            <motion.div
              ...
              className="bg-black/40 backdrop-blur-xl p-6 rounded-2xl border border-emerald-500/20"
            >
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-white">Track Your Spending</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-white">Create Smart Budgets</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-white">Get Financial Insights</h3>
            ...
            >
              ...
              >
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 h-5 w-5 group-hover:text-emerald-400 transition-colors" />
                  <Input
                    id="name"
                    name="name"
              ...
              <div className="flex items-start space-x-3">
                <Checkbox 
                  ...
                  className="border-white/20 data-[state=checked]:bg-emerald-500 data-[state=checked]:border-emerald-500 mt-1"
                />
                <label
                  htmlFor="terms"
